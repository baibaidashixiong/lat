...
GOALIAS("libGLESv2.so.2", libgl)
GOALIAS("libGLESv2.so", libgl)
GOALIAS("libvulkan.so", vulkan)
GOALIAS("libwayland-client.so", waylandclient)
GOALIAS("libwayland-cursor.so.0", waylandcursor)
GOALIAS("libwayland-egl.so.1", waylandegl)
