...
EXPORT int my_wl_proxy_add_listener(void* proxy, void** l, void* data);
EXPORT void my_wl_log_set_handler_client(void* f);
...
static void my_wl_log_func_t_##A(void* fmt, x64_va_list_t args)     \
{                                                                   \
    void* scratch = __builtin_alloca(4096);                         \
    CREATE_VALIST_FROM_VALIST(args, scratch);                       \
    RunFunction(my_wl_log_func_t_fct_##A, 2, fmt, VARARGS);         \
}
#endif
SUPER()
